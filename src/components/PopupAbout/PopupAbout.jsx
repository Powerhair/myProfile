    ...
    >
      <div className="popup__window">
        ...
        <p className="popup__description">
          ...
          новое. Когда дело касается работы, я всегда вкладываю в нее всю свою
          энергию и стараюсь погрузиться в нее полностью. Я не боюсь задавать
          вопросы и всегда стараюсь сделать все, что в моих силах, чтобы достичь
          ...
          опытом. Я также увлекаюсь изучением новых технологий и нахождением
          новых путей решения проблем. Для меня важно быть в курсе последних
          тенденций и развития в своей области, поэтому я постоянно обучаюсь и
          осваиваю новые навыки. Мне нравится стоять на переднем крае прогресса
          и применять новейшие технологии в своей работе. В целом, я энергичный
          и целеустремленный человек, который всегда готов принимать новые
          вызовы и учиться. Я легко адаптируюсь к новым условиям и быстро
          достигаю результатов. Мне нравится исследовать новые горизонты и найти
